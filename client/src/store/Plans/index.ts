  ...
  actions: {
    deletePlan({state,dispatch}:any,payload:string){
      axios.delete("/delete",{
        ...
        if(type === "daily"){
          dispatch("plans/currentPlans/fetchTodaysPlans",null,{ root: true })
          dispatch("plans/dailyPlans/fetchPlans",null,{ root: true })
        } else if(type === "monthly") {
          dispatch("plans/currentPlans/fetchCurrentMonthPlans",null,{ root: true })
          dispatch("plans/monthlyPlans/fetchPlans",null,{ root: true })
        } else if(type === "yearly") {
          dispatch("plans/currentPlans/fetchCurrentYearPlans",null,{ root: true })
