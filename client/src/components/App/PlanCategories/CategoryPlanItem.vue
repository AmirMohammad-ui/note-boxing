  ...
  <div class="category-plan-container">
    ...
    <div class="relative overflow-hidden box">
      ...
      <div class="category-plan-controls">
        ...
        <base-button @click="editPlan(_id)" class="button" w="30px" icon bg-color="white">
        ...
        <base-button @click="finishedPlan(_id)" class="button" w="30px" icon bg-color="#00745D">
        ...
        <base-button @click="deletePlan(_id)" class="button" w="30px" icon bg-color="#D63031">
