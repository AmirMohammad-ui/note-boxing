  ...
  <div class="category-plan-container">
    <div class="flex space-x-2 text-sm">
      ...
      <base-input
        ...
        :z-index="-10"
        lable="status"
        :value="planItemData.status === finishedStatus ? 'Finished' : 'In Progress'"
        :bg-color="planItemData.status === finishedStatus ? '#D63031' : '#00CEC9'"
        color="#fff"
      />
    </div>
    <div class="relative overflow-hidden box">
      ...
      <div class="category-plan-controls">
        ...
        <base-button @click="editPlan(planItemData._id)" class="button" w="30px" icon bg-color="white">
          ...
          <div class="tooltip box">Edit</div>
        </base-button>
        <base-button @click="finishedPlan(planItemData._id)" class="button" w="30px" icon bg-color="#00745D">
          ...
          <div class="tooltip box">Done</div>
        </base-button>
        <base-button @click="deletePlan(planItemData._id)" class="button" w="30px" icon bg-color="#D63031">
          ...
          <div class="tooltip box">Delete</div>
        </base-button>
      </div>
    </div>
