<template>
  <container border-left class="pr-3">
    <div class="hero-section">
      <h1>Plans Found According To Search: {{plansFoundList.length}}</h1>
    </div>
    <ul>
      <li v-for="plan in plansFoundList" class="mb-20" :key="plan.id">
        <the-plan :no-border="true" container-style="padding: 0 10px 0 10px" :data="plan">
          <seperator class="hidden lg:flex" right center left>
            <template #left><span class="font-extrabold">{{leftSeperatorText}}</span></template>
            <template #right>
              <div class="flex items-center space-x-2">
                <base-button icon bg-color="white">
                  <svg
                    width="1.5rem"
                    height="1.5rem"
                    viewBox="0 0 12 12"
                ...
                <base-button icon bg-color="#00745D">
                  <svg
                    width="1.6rem"
                    viewBox="0 0 13 8"
                  >
                ...
                <base-button icon bg-color="#D63031">
                  <svg
                    width="1.5rem"
                    height="1.7rem"
                    viewBox="0 0 10 11"
            ...
            <template #center><span class="font-extralight">{{rightSeperatorText}}</span></template>
          </seperator>
        </the-plan>
      </li>
    </ul>
...
export default {
  components: {ThePlan},
  props: ['leftSeperatorText','rightSeperatorText'],
  data(){
    return {
      plansFoundList: [
        {id: 'p1',startDate: '2020/04/05',finishDate: '2021/04/25',isFinished: false,img: 'img-1',title: 'Finishing the Vue.js course and master it.',description: 'You Must Finish The Vue.Js Fully Undrestand And Have Everything Needed Already In Mind'},
        {id: 'p2',startDate: '2020/04/05',finishDate: '2021/04/25', isFinished: false,img: 'img-2',title: 'Finishing the JS course and master it.',description: 'You Must Finish The Vue.Js Fully Undrestand And Have Everything Needed Already In Mind'},
        {id: 'p3',startDate: '2020/04/05',finishDate: '2021/04/25', isFinished: true,img: 'img-3',title: 'Finishing the React.js course and master it.',description: 'You Must Finish The Vue.Js Fully Undrestand And Have Everything Needed Already In Mind'},
        {id: 'p4',startDate: '2020/04/05',finishDate: '2021/04/25', isFinished: false,img: 'img-4',title: 'Finishing the React.js course and master it.',description: 'You Must Finish The Vue.Js Fully Undrestand And Have Everything Needed Already In Mind'},
        {id: 'p5',startDate: '2020/04/05',finishDate: '2021/04/25', isFinished: true,img: 'img-5',title: 'Finishing the React.js course and master it.',description: 'You Must Finish The Vue.Js Fully Undrestand And Have Everything Needed Already In Mind'},
      ]
    }
  }
}
