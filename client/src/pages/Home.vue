  ...
  <div class="m-4">
    <container class="w-full">
      ...
      <seperator class="hidden lg:flex" right center left>
        <template #left><span class="font-extrabold">Today's Plan</span></template>
        <template #right>
        ...
        <template #center><span class="font-extralight">2021/03/04</span></template>
      </seperator>
    </container>
      ...
      <div class="flex-col items-center content-center space-y-4">
        ...
        <div class="items-start space-y-4 sm:space-y-0 sm:space-x-4 todays-plan-display">
          <div class="relative todays-image-container">
            <img class="todays-image box" src="../assets/annie-spratt-Zxl_m4KVZDs-unsplash.jpg" alt="">
